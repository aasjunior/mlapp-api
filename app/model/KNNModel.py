...
class KNNModel:
    def __init__(self, data_model: DataModel, neighboor: int):
    ...
    def train_and_evaluate(self, test_size=0.3, train_size=0.7):
        X = self.data_model.data[self.data_model.categorical_cols]
        y = self.data_model.data[self.data_model.numeric_cols]
